...
const FooterComponent = () => {
    return (
        <footer className="bg-gray-100">
            <div className="container p-4 mt-16 grid  gap-12 xl:col-span-4 xl:mt-0  md:grid md:grid-cols-4 md:gap-8">
                <div>
                ...
                <div className="mt-10 md:mt-0">
                    ...
                    <ul role="list" className="mt-6 space-y-2">
                        <li>
                            <Link className="text-gray-900 hover:text-gray-700 dark:text-white dark:hover:text-gray-300 hover:underline" href="https://github.com/chornthoen">
                                <div class="flex items-center gap-2">
                        ...
                        <li>
                        <Link className="text-gray-900 hover:text-gray-700 dark:text-white dark:hover:text-gray-300 hover:underline" href="https://www.facebook.com/thoenchorn">
                                <div class="flex items-center gap-2">
                        ...
                        <li>
                        <Link className="text-gray-900 hover:text-gray-700 dark:text-white dark:hover:text-gray-300 hover:underline" href="https://www.linkedin.com/in/chornthoen/">
                                <div class="flex items-center gap-2">
                        ...
                        <li>
                        <Link className="text-gray-900 hover:text-gray-700 dark:text-white dark:hover:text-gray-300 hover:underline" href="https://x.com/ChornThoen">
                                <div class="flex items-center gap-2">
