    ...
    const dataCard = [
        {
            ...
            description: "I build scalable and secure backend applications using Spring Boot."
        },
        {
            ...
            description: "I build cross-platform mobible application using Flutter and build native IOS application using Kotlin."
        },
        {
