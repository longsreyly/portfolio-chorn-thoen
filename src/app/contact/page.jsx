                ...
                <div className="container px-4 md:px-6">
                    <div className="mx-auto max-w-3xl space-y-8">
                        ...
                        <form action="" className="space-y-4">
                            ...
                            {/* button send message */}
                            <a href="mailto:thoenchorn@gmail.com" className="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-gray-900 text-primary-foreground hover:bg-gray-800 h-10 px-4 py-2" type="submit">
                                Send Message
                            </a>
                        </form>
                    </div>
